...
createApp({
    setup() {
        ...
        const questionsDB = {
            ...
            hod: {
                nast: [
                    "Вопрос 1. Участие в адаптации обучающихся к организационно-педагогическим условиям реализации ОПОП и особенностям образовательного процесса в университете.",
                    "Вопрос 2. Консультирование по организационным вопросам и индивидуальным образовательным траекториям: выбор факультативных дисциплин, программ ДПО, иновационным форматам ВКР",
